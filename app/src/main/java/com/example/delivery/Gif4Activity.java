...
public class Gif4Activity extends AppCompatActivity {
    ...
    private void addToCart(String productName, String price, int quantity) {
        ...
        databaseReference.child(id).setValue(cartItem)
                .addOnSuccessListener(aVoid -> Toast.makeText(Gif4Activity.this, "Added to cart", Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(Gif4Activity.this, "Failed to add to cart", Toast.LENGTH_SHORT).show());
    }
